...
DASPy is licensed under the MIT License. [A preprint of DASPy paper](document/Hu_and_Li_DASPy_preprint.pdf) and [a Chinese version of DASPy tutorial](https://daspy-tutorial-cn.readthedocs.io/zh-cn/latest/) is available. If you have any questions, please contact [my email](hmz2018@mail.ustc.edu.cn).
